...
| 1.1.2   | Updated dependencies to fix the "potential security vulnerability" message.
| 1.1.3   | Fixed small bug: Formatting didn't work on the first line if there where variables on first lines.
